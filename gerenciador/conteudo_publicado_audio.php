...
if ($codaudio) {
	...
	$postador = $audiobo->getPostadorConteudo($audiobo->getValorCampo('codautor'));
	$autores_ficha = $audiobo->getAutoresFichaConteudo($codaudio);
	$colaborador = $audiobo->getColaboradorConteudo($audiobo->getValorCampo('codcolaborador'));
...
<div id="autores" class="separador">
		...
		<div class="separador">
	        ...
	        <strong>Tags: </strong> <?=str_replace(';', ',', $audiobo->getValorCampo('tags'));?>
		</div>
