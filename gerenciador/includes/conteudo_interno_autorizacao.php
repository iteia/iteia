<div class="box">
        ...
        <p>
          <input type="radio" name="pedir_autorizacao" value="1" id="aut_0" <?=Util::iif($contbo->getValorCampo('pedir_autorizacao') == 1, 'checked="checked"');?> class="radio" onclick="javascript:$('#conteudo_enviar_para').hide();" />
          ...
          <br />
          <input type="radio" name="pedir_autorizacao" <?=Util::iif($contbo->getValorCampo('pedir_autorizacao') == 2, 'checked="checked"');?> value="2" id="aut_1" class="radio" onclick="javascript:$('#conteudo_enviar_para').show();" />
          <label for="aut_1">solicite a autoriza&ccedil;&atilde;o de um <strong>colaborador</strong> espec&iacute;fico</label>
 
          
        </p>
        <div class="fechada" id="conteudo_enviar_para">
...
<?php
	if ($contbo->getValorCampo("pedir_autorizacao") == 2):
		echo '$("#conteudo_enviar_para").show();';
	endif;
?>
</script>