...
$_GET['palavrachave'] = 'administrador';
$_GET['buscarpor'] = 'administrador';
$_GET['buscar'] = 1;
$_GET['usuario'] = 1;
...
?>
    ...
    <form method="get" id="form-result" action="cadastro_colaboradores.php">
          <h3 class="titulo"><?=Util::iif($buscar, 'Resultado da busca', 'Administradores');?></h3>
