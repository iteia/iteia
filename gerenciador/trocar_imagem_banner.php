...
options = {
		url: "conteudo_ajax.php?get=imagem_banner_upload",
		target: "#imagem_html",
		type: "post",
...
function reexibeImagem() {
	...
	if (imagemtemp.length) {
        ...
        $('#ban').after("<div class=\"box box-alerta\" id=\"erro\"><h3>A imagem tem mais de 20Kb.</h3></div>");
	}
}
...
<p id="ban">Os banners aparecer&atilde;o em diferentes locais do portal, com ordem aleat&oacute;ria. Eles devem ter o tamanho exato de 180 pixels x 150 pixels e podem ser animados (em GIF) ou est&aacute;ticos (em formato de imagem).</p>
