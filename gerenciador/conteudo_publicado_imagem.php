...
if ($codalbum) {
	...
	$postador = $albumbo->getPostadorConteudo($albumbo->getValorCampo('codautor'));
	$autores_ficha = $albumbo->getAutoresFichaConteudo($codalbum);
	$colaborador = $albumbo->getColaboradorConteudo($albumbo->getValorCampo('codcolaborador'));
...
<div class="box">
    ...
    <div class="separador">
        ...
        <strong>Tags: </strong> <?=str_replace(';', ',', $albumbo->getValorCampo('tags'));?>
	</div>
