...
class PlayerUtil {
	...
	public static function urlArquivo($arquivo, $tipo) {
		if ($tipo == 1) {
			$AgetHeaders = @get_headers('http://www.iteia.org.br/conteudo/videos/convertidos/'.$arquivo);
			if (preg_match("|200|", $AgetHeaders[0]))
				return 'http://www.iteia.org.br/conteudo/videos/convertidos/'.$arquivo;
			return ConfigVO::getUrlVideo().$arquivo;
		}
		elseif ($tipo == 2) {
			$AgetHeaders = @get_headers('http://www.iteia.org.br/conteudo/audios/'.$arquivo);
			if (preg_match("|200|", $AgetHeaders[0]))
				return 'http://www.iteia.org.br/conteudo/audios/'.$arquivo;
