...
//echo $sql;
	...
	public function getResultadoBuscaFiltro($get) {
		...
		// se tiver cod deve buscar em todos os tipos
		if ($cod)
		...
		if ($aud || $audios)
			...
			$html .= '<li><a href="'.$link.'">Áudios</a> ('.$total_audios.')</li>';
		
		if ($vid || $videos)
			$html .= '<li class="filtro">Vídeos ('.$total_videos.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Vídeos </a> ('.$total_videos.')</li>';
		
		if ($txt || $textos)
			$html .= '<li class="filtro">Textos ('.$total_textos.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Textos</a> ('.$total_textos.')</li>';

		if ($img || $imagens)
			$html .= '<li class="filtro">Imagens ('.$total_imagens.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Imagens</a> ('.$total_imagens.')</li>';

		if ($not || $noticias)
			$html .= '<li class="filtro">Notícias ('.$total_noticias.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Notícias</a> ('.$total_noticias.')</li>';

		if ($agd || $agenda)
			$html .= '<li class="filtro">Eventos ('.$total_eventos.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Eventos</a> ('.$total_eventos.')</li>';

		if($can || $canais) 
		    $html .= '<li class="filtro">Canais ('.$total_canais.')</li>';
		else
		    $html .= '<li><a href="'.$link.'" class="canal">Canais</a> ('.$total_canais.')</li>';

		if ($aut || $autores)
			$html .= '<li class="filtro">Autores ('.$total_autores.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Autores</a> ('.$total_autores.')</li>';

		if ($col || $colaboradores)
			$html .= '<li class="filtro">Colaboradores ('.$total_colaboradores.')</li>';
		else
			$html .= '<li><a href="'.$link.'">Colaboradores</a> ('.$total_colaboradores.')</li>';
