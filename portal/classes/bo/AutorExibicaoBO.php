...
class AutorExibicaoBO {
    ...
    public function exibirConteudo() {
		...
		$autor['autor']['exibir_endereco'] = $this->autordao->getExibirEndereco($this->cod_autor);
        ...
        $autor['autor']['num_eventos_proprio'] = $this->getNumeroConteudoProprio($this->cod_autor, 6);
        $autor['autor']['num_noticias_proprio'] = $this->getNumeroConteudoProprio($this->cod_autor, 5);
        ...
        $autor['autor']['num_eventos'] = $this->getNumeroConteudo($this->cod_autor, 6) + $autor['autor']['num_eventos_proprio'];
        $autor['autor']['num_noticias'] = $this->getNumeroConteudo($this->cod_autor, 5) + $autor['autor']['num_noticias_proprio'];
