...
<?php if($conteudo['conteudo']['imagem']): ?>
    <div class="box-imagem">
		<a href="/exibir_imagem.php?img=<?=$conteudo['conteudo']['imagem']?>&amp;tipo=1&amp;s=11" class="thickbox ampliar-imagem">ampliar</a>
		<?php if($conteudo['dados_arquivo']['foto_credito']): ?>
		<small class="credito"><?=$conteudo['dados_arquivo']['foto_credito'];?></small>
		<?php endif; ?>
		<a class="thickbox" href="/exibir_imagem.php?img=<?=$conteudo['conteudo']['imagem']?>&amp;tipo=1&amp;s=11"><img src="/exibir_imagem.php?img=<?=$conteudo['conteudo']['imagem']?>&amp;tipo=1&amp;s=30" alt="Descrição da Foto" /></a>
...
<?php
if ($conteudo['dados_arquivo']):?>
<div id="anexos">
            <h4>Documentos anexados</h4>
            <ul>
			  <?php foreach($conteudo['dados_arquivo'] as $arquivo):?>
              	  <li class="doc"><a href="/salvar.php?c=<?=intval($arquivo->cod_anexo);?>&amp;f=<?=intval($conteudo['conteudo']['cod_formato'])?>&amp;a=1"><?=$arquivo->nome_arquivo_original;?></a></li>
			  <?php endforeach; ?>
              </ul>
          </div>
<?php endif; ?>        
